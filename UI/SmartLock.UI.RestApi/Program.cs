...
//app.UseAutoMigrateRelationalDataBase(); //In order to use Inmemory dbcontext, comment this line of code

app.UseIMemorySeeds(); // Commmit this line, if you want to use sql server.
